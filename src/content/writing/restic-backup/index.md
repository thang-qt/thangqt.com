...
I followed [this guide](https://imranmustafa.net/simple-restic-backup-on-nixos/) which breaks down the setup nicely. You can check out my config here:

- https://github.com/thang-qt/nixcfg/blob/main/modules/nixos/restic.nix
